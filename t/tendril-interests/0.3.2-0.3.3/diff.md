# Comparing `tmp/tendril-interests-0.3.2.tar.gz` & `tmp/tendril-interests-0.3.3.tar.gz`
...
### Comparing `tendril-interests-0.3.2/docs/conf.py` & `tendril-interests-0.3.3/docs/conf.py`
