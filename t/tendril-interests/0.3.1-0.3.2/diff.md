# Comparing `tmp/tendril-interests-0.3.1.tar.gz` & `tmp/tendril-interests-0.3.2.tar.gz`
...
### Comparing `tendril-interests-0.3.1/docs/conf.py` & `tendril-interests-0.3.2/docs/conf.py`
