# Comparing `tmp/Geode_Explicit-4.1.3-cp39-cp39-manylinux2014_x86_64.whl.zip` & `tmp/Geode_Explicit-4.1.3rc1-cp39-cp39-win_amd64.whl.zip`

## zipinfo {}

```diff
@@ -1,14 +1,14 @@
-Zip file size: 354602 bytes, number of entries: 12
--rw-r--r--  2.0 unx       89 b- defN 23-Jul-29 00:59 geode_explicit/__init__.py
--rw-r--r--  2.0 unx      261 b- defN 23-Jul-29 00:59 geode_explicit/brep.py
--rw-r--r--  2.0 unx      240 b- defN 23-Jul-29 00:59 geode_explicit/section.py
--rwxr-xr-x  2.0 unx   171552 b- defN 23-Jul-29 00:59 geode_explicit/lib64/geode_explicit_py_brep.cpython-39-x86_64-linux-gnu.so
--rwxr-xr-x  2.0 unx   147016 b- defN 23-Jul-29 00:59 geode_explicit/lib64/geode_explicit_py_section.cpython-39-x86_64-linux-gnu.so
--rwxr-xr-x  2.0 unx   489264 b- defN 23-Jul-29 00:59 geode_explicit/lib64/libGeode-Explicit_brep.so
--rwxr-xr-x  2.0 unx    39496 b- defN 23-Jul-29 00:59 geode_explicit/lib64/libGeode-Explicit_common.so
--rwxr-xr-x  2.0 unx    72760 b- defN 23-Jul-29 00:59 geode_explicit/lib64/libGeode-Explicit_section.so
--rw-r--r--  2.0 unx     2314 b- defN 23-Jul-29 00:59 Geode_Explicit-4.1.3.dist-info/METADATA
--rw-r--r--  2.0 unx      103 b- defN 23-Jul-29 00:59 Geode_Explicit-4.1.3.dist-info/WHEEL
--rw-r--r--  2.0 unx       15 b- defN 23-Jul-29 00:59 Geode_Explicit-4.1.3.dist-info/top_level.txt
--rw-rw-r--  2.0 unx     1154 b- defN 23-Jul-29 00:59 Geode_Explicit-4.1.3.dist-info/RECORD
-12 files, 924264 bytes uncompressed, 352622 bytes compressed:  61.8%
...
-Filename: Geode_Explicit-4.1.3.dist-info/METADATA
+Filename: Geode_Explicit-4.1.3rc1.dist-info/METADATA
 Comment: 
 
-Filename: Geode_Explicit-4.1.3.dist-info/WHEEL
+Filename: Geode_Explicit-4.1.3rc1.dist-info/WHEEL
 Comment: 
 
-Filename: Geode_Explicit-4.1.3.dist-info/top_level.txt
+Filename: Geode_Explicit-4.1.3rc1.dist-info/top_level.txt
 Comment: 
 
-Filename: Geode_Explicit-4.1.3.dist-info/RECORD
...
## Comparing `Geode_Explicit-4.1.3.dist-info/METADATA` & `Geode_Explicit-4.1.3rc1.dist-info/METADATA`
...
-Requires-Dist: opengeode-geosciencesio (==4.*,>=4.2.1)
...
```diff
@@ -1,16 +1,16 @@
-Metadata-Version: 2.1 Name: Geode-Explicit Version: 4.1.3 Summary: Geode-
...
-text/markdown Requires-Dist: geode-background (==7.*,>=7.3.1) Requires-Dist:
-geode-common (==26.*,>=26.1.5) Requires-Dist: geode-conversion (==5.*,>=5.0.9)
-Requires-Dist: opengeode-core (==14.*,>=14.4.5) Requires-Dist: opengeode-
-geosciences (==7.*,>=7.1.4) Requires-Dist: opengeode-geosciencesio
-(==4.*,>=4.2.1) Requires-Dist: opengeode-inspector (==3.*,>=3.0.8) Requires-
-Dist: opengeode-io (==6.*,>=6.0.10)
