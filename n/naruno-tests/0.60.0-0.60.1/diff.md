# Comparing `tmp/naruno_tests-0.60.0.tar.gz` & `tmp/naruno_tests-0.60.1.tar.gz`
...
## Comparing `naruno_tests-0.60.0.tar` & `naruno_tests-0.60.1.tar`
...
### Comparing `naruno_tests-0.60.0/setup.py` & `naruno_tests-0.60.1/setup.py`
