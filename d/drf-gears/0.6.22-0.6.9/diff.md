# Comparing `tmp/drf-gears-0.6.22.tar.gz` & `tmp/drf-gears-0.6.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "drf-gears-0.6.22.tar", last modified: Sat Jul 29 15:22:35 2023, max compression
+gzip compressed data, was "drf-gears-0.6.9.tar", last modified: Wed Aug 31 19:33:46 2022, max compression
```

## Comparing `drf-gears-0.6.22.tar` & `drf-gears-0.6.9.tar`

### file list

```diff
@@ -1,39 +1,37 @@
-drwxr-xr-x   0 alexander   (501) staff       (20)        0 2023-07-29 15:22:35.246129 drf-gears-0.6.22/
--rw-r--r--   0 alexander   (501) staff       (20)     1069 2022-08-31 14:23:16.000000 drf-gears-0.6.22/LICENSE
--rw-r--r--   0 alexander   (501) staff       (20)     9865 2023-07-29 15:22:35.245761 drf-gears-0.6.22/PKG-INFO
--rw-r--r--   0 alexander   (501) staff       (20)     8080 2022-08-31 06:54:14.000000 drf-gears-0.6.22/README.md
--rw-r--r--   0 alexander   (501) staff       (20)      553 2023-07-29 15:22:22.000000 drf-gears-0.6.22/pyproject.toml
--rw-r--r--   0 alexander   (501) staff       (20)       38 2023-07-29 15:22:35.246220 drf-gears-0.6.22/setup.cfg
-drwxr-xr-x   0 alexander   (501) staff       (20)        0 2023-07-29 15:22:35.224765 drf-gears-0.6.22/src/
--rw-r--r--   0 alexander   (501) staff       (20)        0 2022-08-31 17:27:37.000000 drf-gears-0.6.22/src/__init__.py
-drwxr-xr-x   0 alexander   (501) staff       (20)        0 2023-07-29 15:22:35.226107 drf-gears-0.6.22/src/drf_gears.egg-info/
--rw-r--r--   0 alexander   (501) staff       (20)     9865 2023-07-29 15:22:35.000000 drf-gears-0.6.22/src/drf_gears.egg-info/PKG-INFO
--rw-r--r--   0 alexander   (501) staff       (20)      780 2023-07-29 15:22:35.000000 drf-gears-0.6.22/src/drf_gears.egg-info/SOURCES.txt
--rw-r--r--   0 alexander   (501) staff       (20)        1 2023-07-29 15:22:35.000000 drf-gears-0.6.22/src/drf_gears.egg-info/dependency_links.txt
--rw-r--r--   0 alexander   (501) staff       (20)       15 2023-07-29 15:22:35.000000 drf-gears-0.6.22/src/drf_gears.egg-info/top_level.txt
-drwxr-xr-x   0 alexander   (501) staff       (20)        0 2023-07-29 15:22:35.227573 drf-gears-0.6.22/src/gears/
--rw-r--r--   0 alexander   (501) staff       (20)        0 2022-08-31 17:27:25.000000 drf-gears-0.6.22/src/gears/__init__.py
--rw-r--r--   0 alexander   (501) staff       (20)       43 2022-08-31 14:30:39.000000 drf-gears-0.6.22/src/gears/example.py
--rw-r--r--   0 alexander   (501) staff       (20)      523 2022-08-22 18:21:05.000000 drf-gears-0.6.22/src/gears/mixins.py
-drwxr-xr-x   0 alexander   (501) staff       (20)        0 2023-07-29 15:22:35.236267 drf-gears-0.6.22/src/gears/models/
--rw-r--r--   0 alexander   (501) staff       (20)        0 2022-08-31 16:41:07.000000 drf-gears-0.6.22/src/gears/models/__init__.py
--rw-r--r--   0 alexander   (501) staff       (20)     2281 2023-07-29 15:22:22.000000 drf-gears-0.6.22/src/gears/models/change.py
--rw-r--r--   0 alexander   (501) staff       (20)     3669 2022-08-31 20:29:26.000000 drf-gears-0.6.22/src/gears/models/jwt.py
--rw-r--r--   0 alexander   (501) staff       (20)      993 2022-09-15 17:18:53.000000 drf-gears-0.6.22/src/gears/models/singleton.py
-drwxr-xr-x   0 alexander   (501) staff       (20)        0 2023-07-29 15:22:35.240084 drf-gears-0.6.22/src/gears/renderers/
--rw-r--r--   0 alexander   (501) staff       (20)        0 2022-08-31 16:39:27.000000 drf-gears-0.6.22/src/gears/renderers/__init__.py
--rw-r--r--   0 alexander   (501) staff       (20)     3346 2023-02-28 09:58:58.000000 drf-gears-0.6.22/src/gears/renderers/exception_handlers.py
--rw-r--r--   0 alexander   (501) staff       (20)      314 2022-08-31 16:39:41.000000 drf-gears-0.6.22/src/gears/renderers/mapping.py
--rw-r--r--   0 alexander   (501) staff       (20)     1795 2022-08-31 16:39:48.000000 drf-gears-0.6.22/src/gears/renderers/renderer.py
--rw-r--r--   0 alexander   (501) staff       (20)      385 2022-08-31 16:39:54.000000 drf-gears-0.6.22/src/gears/renderers/types.py
-drwxr-xr-x   0 alexander   (501) staff       (20)        0 2023-07-29 15:22:35.241416 drf-gears-0.6.22/src/gears/serializers/
--rw-r--r--   0 alexander   (501) staff       (20)        0 2022-08-31 16:41:07.000000 drf-gears-0.6.22/src/gears/serializers/__init__.py
--rw-r--r--   0 alexander   (501) staff       (20)      481 2022-08-31 16:40:18.000000 drf-gears-0.6.22/src/gears/serializers/jwt.py
-drwxr-xr-x   0 alexander   (501) staff       (20)        0 2023-07-29 15:22:35.242403 drf-gears-0.6.22/src/gears/views/
--rw-r--r--   0 alexander   (501) staff       (20)        0 2022-08-31 16:41:07.000000 drf-gears-0.6.22/src/gears/views/__init__.py
--rw-r--r--   0 alexander   (501) staff       (20)      353 2022-08-31 20:02:15.000000 drf-gears-0.6.22/src/gears/views/jwt.py
-drwxr-xr-x   0 alexander   (501) staff       (20)        0 2023-07-29 15:22:35.244958 drf-gears-0.6.22/src/gears/viewsets/
--rw-r--r--   0 alexander   (501) staff       (20)        0 2022-08-31 16:41:07.000000 drf-gears-0.6.22/src/gears/viewsets/__init__.py
--rw-r--r--   0 alexander   (501) staff       (20)      724 2022-08-31 16:40:43.000000 drf-gears-0.6.22/src/gears/viewsets/permissions.py
--rw-r--r--   0 alexander   (501) staff       (20)     1096 2022-08-31 16:40:48.000000 drf-gears-0.6.22/src/gears/viewsets/querysets.py
--rw-r--r--   0 alexander   (501) staff       (20)     1153 2022-08-31 16:40:56.000000 drf-gears-0.6.22/src/gears/viewsets/serializers.py
...
### Comparing `drf-gears-0.6.22/LICENSE` & `drf-gears-0.6.9/LICENSE`

 * *Files identical despite different names*

### Comparing `drf-gears-0.6.22/PKG-INFO` & `drf-gears-0.6.9/PKG-INFO`
...
### Comparing `drf-gears-0.6.22/README.md` & `drf-gears-0.6.9/README.md`

 * *Files identical despite different names*

### Comparing `drf-gears-0.6.22/pyproject.toml` & `drf-gears-0.6.9/pyproject.toml`
...
### Comparing `drf-gears-0.6.22/src/drf_gears.egg-info/PKG-INFO` & `drf-gears-0.6.9/src/drf_gears.egg-info/PKG-INFO`
...
### Comparing `drf-gears-0.6.22/src/drf_gears.egg-info/SOURCES.txt` & `drf-gears-0.6.9/src/drf_gears.egg-info/SOURCES.txt`
...
### Comparing `drf-gears-0.6.22/src/gears/mixins.py` & `drf-gears-0.6.9/src/gears/mixins.py`

 * *Files identical despite different names*

### Comparing `drf-gears-0.6.22/src/gears/models/jwt.py` & `drf-gears-0.6.9/src/gears/models/jwt.py`
...
### Comparing `drf-gears-0.6.22/src/gears/renderers/exception_handlers.py` & `drf-gears-0.6.9/src/gears/renderers/exception_handlers.py`
...
### Comparing `drf-gears-0.6.22/src/gears/renderers/renderer.py` & `drf-gears-0.6.9/src/gears/renderers/renderer.py`

 * *Files identical despite different names*

### Comparing `drf-gears-0.6.22/src/gears/viewsets/permissions.py` & `drf-gears-0.6.9/src/gears/viewsets/permissions.py`

 * *Files identical despite different names*

### Comparing `drf-gears-0.6.22/src/gears/viewsets/querysets.py` & `drf-gears-0.6.9/src/gears/viewsets/querysets.py`

 * *Files identical despite different names*

### Comparing `drf-gears-0.6.22/src/gears/viewsets/serializers.py` & `drf-gears-0.6.9/src/gears/viewsets/serializers.py`
