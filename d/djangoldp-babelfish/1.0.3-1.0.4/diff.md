# Comparing `tmp/djangoldp_babelfish-1.0.3.tar.gz` & `tmp/djangoldp_babelfish-1.0.4.tar.gz`
...
## Comparing `djangoldp_babelfish-1.0.3.tar` & `djangoldp_babelfish-1.0.4.tar`
...
### Comparing `djangoldp_babelfish-1.0.3/README.md` & `djangoldp_babelfish-1.0.4/README.md`

 * *Files identical despite different names*

### Comparing `djangoldp_babelfish-1.0.3/djangoldp_babelfish/migrations/0001_initial.py` & `djangoldp_babelfish-1.0.4/djangoldp_babelfish/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `djangoldp_babelfish-1.0.3/djangoldp_babelfish/migrations/0002_auto_20230720_1705.py` & `djangoldp_babelfish-1.0.4/djangoldp_babelfish/migrations/0002_auto_20230720_1705.py`

 * *Files identical despite different names*

### Comparing `djangoldp_babelfish-1.0.3/djangoldp_babelfish/models.py` & `djangoldp_babelfish-1.0.4/djangoldp_babelfish/models.py`
...
### Comparing `djangoldp_babelfish-1.0.3/djangoldp_babelfish/views.py` & `djangoldp_babelfish-1.0.4/djangoldp_babelfish/views.py`

 * *Files identical despite different names*

### Comparing `djangoldp_babelfish-1.0.3/djangoldp_babelfish.egg-info/SOURCES.txt` & `djangoldp_babelfish-1.0.4/djangoldp_babelfish.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `djangoldp_babelfish-1.0.3/setup.cfg` & `djangoldp_babelfish-1.0.4/setup.cfg`
